  ...
  return (
    <div className="min-h-screen bg-[#F9F8F3] text-[#1C1B18]">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-3">
              ...
              <span className="font-serif text-xl font-bold tracking-tight">
                ATELIER <span className="text-[#A37D4C]">Coupon Portal</span>
              </span>
            </div>
            ...
            <div className="flex items-center space-x-6">
              <nav className="flex items-center space-x-4 text-xs font-semibold">
                ...
                <Link href="/admin/coupons" className="text-[#A37D4C] border-b-2 border-[#A37D4C] py-2">
                  Kode Kupon Diskon
                </Link>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
        ...
        <div className="bg-white p-6 rounded-2xl border border-[#E6E3D8] shadow-xs space-y-4">
          <h3 className="font-serif text-lg font-bold text-[#1C1B18] flex items-center space-x-2">
          ...
          <form onSubmit={handleCreateCoupon} className="grid grid-cols-1 sm:grid-cols-4 gap-4 items-end text-xs">
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 rounded-lg border border-[#E6E3D8] uppercase font-mono text-xs"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 rounded-lg border border-[#E6E3D8] text-xs font-semibold"
              />
            </div>
            ...
            <button
              type="submit"
              className="py-2.5 bg-[#0F4C3A] hover:bg-[#1C1B18] text-white font-bold rounded-lg transition-all shadow-sm cursor-pointer"
            >
              + Tambah Kupon
            </button>
          </form>
                ...
                {coupons.length > 0 ? (
                  coupons.map((item) => (
                    <tr key={item.id} className="hover:bg-[#F9F8F3]/60 transition-colors">
                      <td className="p-4 font-mono font-bold text-sm text-[#0F4C3A]">{item.code}</td>
                      <td className="p-4 font-serif font-bold text-sm">-{item.discountPercent}%</td>
                      <td className="p-4 text-[#5C5953]">
                        {item.usedCount} / {item.maxUses} kali
                      </td>
                      <td className="p-4">
                        <span className="bg-[#E6F0EC] text-[#0F4C3A] px-2.5 py-1 rounded-full text-[10px] font-bold">
                          AKTIF
                        </span>
                      </td>
                  ...
                  <tr>
                    <td colSpan={5} className="p-8 text-center text-[#5C5953]">
