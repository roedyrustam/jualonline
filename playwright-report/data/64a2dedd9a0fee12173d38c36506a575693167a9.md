...
Expected pattern: /Bayar Sekarang/
Received string:  "Lanjut Pembayaran DOKU (Rp 179.000)"
```
        ...
        - generic [ref=f1e48]:
          ...
          - generic [ref=f1e54]:
            ...
            - generic [ref=f1e58]:
              ...
              - textbox "email@domain.com" [ref=f1e60]: budi@example.com
            ...
            - generic [ref=f1e62]:
              ...
              - textbox "081234567890" [active] [ref=f1e64]
            - generic [ref=f1e65]:
...
```ts
  ...
  34 |     const payButton = page.getByRole('button', { name: /Lanjut Pembayaran DOKU/i });
